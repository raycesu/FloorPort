import type { SupportedChartRange } from '@/lib/sources/types'
...
export const TTL_CHART_LONG_HARD_MS = getPositiveIntFromEnv(
  'PRICE_CACHE_HARD_TTL_MS_CHART_LONG',
  21 * 24 * 60 * 60 * 1000
)
...
export const chartTtlForRange = (range: SupportedChartRange): { soft: number; hard: number } => {
